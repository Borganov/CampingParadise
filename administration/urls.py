...
urlpatterns = [
    ...
    # path('emplacementByIDjson/<int:gid>.json', views.emplacementByIDjson, name='emplacementByIDjson'),
    path('emplacementByIDjson.json', views.emplacementByIDjson, name='emplacementByIDjson'),
